    ...
    if query.data == "mukesh_":
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs 🍷", url=f"68 74 74 70 73 3A 2F 2F 74 2E 6D 65 2F 49 64 73 70 5F 62 6F 74 73."
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ 🍹", url=f"2F 61 73 6B 20 68 74 74 70 73 3A 2F 2F 67 69 74 68 75 62 2E 63 6F 6D."
                        ),
                    ],
                    [
...
ꜱᴇᴛ ᴀ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇꜱꜱᴀɢᴇ!""",parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_caption("""𝙰ʀᴇ ʏᴏᴜ ɪɴᴛᴇʀᴇ𝚜ᴛᴇᴅ ɪɴ ʜᴇʟᴘɪɴɢ ᴍʏ ᴄʀᴇᴀᴛᴏʀ ᴡɪᴛʜ ʜɪ𝚜 ᴇғғᴏʀᴛ𝚜 ᴛᴏ ᴋᴇᴇᴘ ᴍᴇ ɪɴ ᴀᴄᴛɪᴠᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ? 𝙸ғ ʏᴇ𝚜, 𝚈ᴏᴜ'ʀᴇ ɪɴ ᴛʜᴇ ʀɪɢʜᴛ ᴘʟᴀᴄᴇ. 

𝚆ᴇ ᴇᴍᴘʜᴀ𝚜ɪ𝚜ᴇ ᴛʜᴇ ɪᴍᴘᴏʀᴛᴀɴᴄᴇ ᴏғ ɴᴇᴇᴅɪɴɢ ғᴜɴᴅ𝚜 ᴛᴏ ᴋᴇᴇᴘ 𝚃𝚙 𝙴𝚍𝚒𝚝𝚣 ᴜɴᴅᴇʀ ᴀᴄᴛɪᴠᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ. 𝚈ᴏᴜʀ ᴅᴏɴᴀᴛɪᴏɴ𝚜 ɪɴ ᴀɴʏ ᴀᴍᴏᴜɴᴛ ᴏғ ᴍᴏɴᴇʏ ᴛᴏ 𝚃𝚙 𝙴𝚍𝚒𝚝𝚣 𝚜ᴇʀᴠᴇʀ𝚜 ᴀɴᴅ ᴏᴛʜᴇʀ ᴜᴛɪʟɪᴛɪᴇ𝚜 ᴡɪʟʟ ᴀʟʟᴏᴡ ᴜ𝚜 ᴛᴏ 𝚜ᴜ𝚜ᴛᴀɪɴ ᴛʜᴇ ʟɪғᴇ𝚜ᴘᴀɴ ɪɴ ᴛʜᴇ ʟᴏɴɢ ᴛᴇʀᴍ. 𝚆ᴇ ᴡɪʟʟ ᴜ𝚜ᴇ ᴀʟʟ ᴏғ ᴛʜᴇ ᴅᴏɴᴀᴛɪᴏɴ𝚜 ᴛᴏ ᴄᴏᴠᴇʀ ғᴜᴛᴜʀᴇ ᴇ𝚡ᴘᴇɴ𝚜ᴇ𝚜 ᴀɴᴅ ᴜᴘɢʀᴀᴅᴇ𝚜 ᴏғ ᴛʜᴇ 𝚜ᴇʀᴠᴇʀ𝚜 ᴄᴏ𝚜ᴛ𝚜. 𝙸ғ ʏᴏᴜ'ᴠᴇ ɢᴏᴛ 𝚜ᴘᴀʀᴇ ᴍᴏɴᴇʏ ᴛᴏ ʜᴇʟᴘ ᴜ𝚜 ɪɴ ᴛʜɪ𝚜 ᴇғғᴏʀᴛ, 𝙺ɪɴᴅʟʏ ᴅᴏ 𝚜ᴏ ᴀɴᴅ ʏᴏᴜʀ ᴅᴏɴᴀᴛɪᴏɴ𝚜 ᴄᴀɴ ᴀʟ𝚜ᴏ ᴍᴏᴛɪᴠᴀᴛᴇ ᴜ𝚜 ᴋᴇᴇᴘ ʙʀɪɴɢ ᴏɴ ɴᴇᴡ ғᴇᴀᴛᴜʀᴇ𝚜.

𝚈ᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴ𝚜𝚆ᴇ ᴇᴍᴘʜᴀ𝚜ɪ𝚜ᴇ ᴛʜᴇ ɪᴍᴘᴏʀᴛᴀɴᴄᴇ ᴏғ ɴᴇᴇᴅɪɴɢ ғᴜɴᴅ𝚜 """,parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/Idsp_bots"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="mukesh_support")
                    ]
                ]
            ),
            )  
...
ᴡʀɪᴛᴛᴇɴ ɪɴ ᴩʏᴛʜᴏɴ ᴡɪᴛʜ ᴛʜᴇ ʜᴇʟᴩ ᴏғ : [ᴛᴇʟᴇᴛʜᴏɴ](https://github.com/Telethon)
...
{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](\x68\x74\x74\x70\x73\x3A\x2F\x2F\x67\x69\x74\x68\x75\x62\x2E\x63\x6F\x6D/blob/main/LICENSE).
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url="https://t.me/multiiii_bot?startgroup=true"
                            )
                       ]
                ]
                     )
